...
def post_facebook_message(fbid, received_message):           
	...
	user_details_params = {'fields':'first_name, last_name, profile_pic', 'access_token':'EAAUzZB07kpkIBAIeY4EXAi0wTHtXLKvQqtx2fJFGwYYJKy190y52LpMP2EmhsZC0CdFDFNOZBhpGvgu38NjdqOZBg7lp19hvhvVo6YTkNCwL3G2lTJIY4NnWSYWX0SJZCO7XYOO8QL6vZAZCHKV0ZAUgZBMQHfjfTYADXRMK3pKpimWy5tv1Pc5Ea'}
	user_details = requests.get(user_details_url, user_details_params).json()
	joke_text = 'Hey ' + user_details['first_name'] + '..! ' + joke_text   


    post_message_url = 'https://graph.facebook.com/v2.6/me/messages?access_token=EAAUzZB07kpkIBAIeY4EXAi0wTHtXLKvQqtx2fJFGwYYJKy190y52LpMP2EmhsZC0CdFDFNOZBhpGvgu38NjdqOZBg7lp19hvhvVo6YTkNCwL3G2lTJIY4NnWSYWX0SJZCO7XYOO8QL6vZAZCHKV0ZAUgZBMQHfjfTYADXRMK3pKpimWy5tv1Pc5Ea' 
